...
profile
const bodals5=document.querySelectorAll('.item__icon4')
const modal5=document.querySelector('.profile')
const modalclose5=document.querySelector('.form-profile-header__icon')
const modalbody5=document.querySelector('.modal-profile__body')
...
modalclose5.addEventListener('click',show5)
for(const bodal5 of bodals5){
    bodal5.addEventListener('click',hide5)
}
modal5.addEventListener('click',show5)
modalbody5.addEventListener ('click',function(event5){
